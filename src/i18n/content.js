export const translations = {
  ...
  "AI Tutor",
    ...
    footer: {
      description:
        "HSC শিক্ষার্থীদের জন্য AI-চালিত পদার্থবিদ্যা শিক্ষা এবং বিশেষজ্ঞ সমাধানের মাধ্যমে ক্ষমতায়ন করা।",
      platform: "প্ল্যাটফর্ম",
      resources: "সম্পদ",
      newsletterHeading: "নিউজলেটার",
      newsletterDescription:
        "অধিকশেষে নতুন স্টাডি টিপস এবং প্ল্যাটফর্মের বৈশিষ্ট্য নিয়ে আপডেট থাকুন।",
